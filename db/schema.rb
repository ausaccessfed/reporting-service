...
ActiveRecord::Schema.define(version: 2023_05_29_024659) do

  create_table "activations", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
  ...
  create_table "api_subject_roles", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
  ...
  create_table "api_subjects", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
  ...
  create_table "automated_report_instances", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
  ...
  create_table "automated_report_subscriptions", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
    t.integer "automated_report_id", null: false
  ...
  create_table "automated_reports", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
  ...
  create_table "discovery_service_events", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
  ...
  create_table "federated_login_events", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
  ...
  create_table "identity_provider_saml_attributes", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
  ...
  create_table "identity_providers", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
  ...
  create_table "incoming_f_ticks_events", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
  ...
  create_table "organizations", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
    t.string "identifier", null: false
    t.string "name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "permissions", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
    t.integer "role_id", null: false
  ...
  create_table "rapid_connect_services", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
    t.string "identifier", null: false
    t.string "name", null: false
  ...
  create_table "roles", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "saml_attributes", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
    t.string "name", null: false
    t.string "description", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "service_provider_saml_attributes", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
  ...
  create_table "service_providers", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
    t.string "entity_id", null: false
    t.string "name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "sessions", charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
  ...
  create_table "subject_roles", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
    t.integer "subject_id", null: false
    t.integer "role_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "subjects", id: :integer, charset: "utf8", collation: "utf8_bin", force: :cascade do |t|
