...
ActiveRecord::Schema.define(version: 2024_01_15_042123) do
  ...
  create_table "api_subjects", id: :integer, charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "automated_report_subscriptions", id: :integer, charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
    t.integer "automated_report_id", null: false
  ...
  create_table "automated_reports", id: :integer, charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "discovery_service_events", id: :integer, charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "federated_login_events", id: :integer, charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "incoming_f_ticks_events", id: :integer, charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "rapid_connect_services", id: :integer, charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
    t.string "identifier", null: false
    t.string "name", null: false
  ...
  create_table "service_provider_saml_attributes", id: :integer, charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "subjects", id: :integer, charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
